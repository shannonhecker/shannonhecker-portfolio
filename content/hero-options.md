...
Proposal-only copy for the homepage hero. The live hero is intentionally unchanged because `VOICE.md` marks this surface as high-risk.

## Option 1. Direct hiring scan
...
**Tagline**
Designing the systems behind trading floors.

**Descriptor**
Barclays now. J.P. Morgan for nine years before that. I work on trading UX, design systems, data visualisation, and the tooling that helps product teams ship without losing clarity.
